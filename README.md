...
**The GSEA LeadingEdgeReport module for GenePattern** is based on the open-source GSEA Desktop code base; the initial GitHub commit corresponds to the code base as of August 7, 2017. The earlier code revision history is not available.
...
The GSEA LeadingEdgeReport module for GenePattern is 100% Pure Java.  Java 11 is required for our pre-built binaries.  Builds against other versions of Java may be possible but are unsupported.
